...
# Check if HIP BLAS is available
from llama_cpp import Llama
print('\n--- Loading Model ---')
print('Model: Llama 3.2 3B Instruct (Q4_K_M GGUF)')
print('Path: /workspace/template-repos/template-1005/repo/models/Llama-3.2-3B-Instruct-Q4_K_M.gguf')
...
# Check backend
print('Backend:', llm.metadata.get('backend', 'unknown'))
