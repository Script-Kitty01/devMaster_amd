"""Install missing dependencies on the Radeon Cloud instance."""
...
result = subprocess.run([sys.executable, '-m', 'pip', 'install', 'chromadb', 'langgraph', 'langchain-core', 'langchain-community'], 
...
run_code("""
import importlib
for mod in ['chromadb', 'langgraph', 'langchain_core']:
    try:
