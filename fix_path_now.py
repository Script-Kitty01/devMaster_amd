...
old_path = '/workspace/demo_repos/sample_app'
new_path = '/workspace/template-repos/template-1005/repo/demo_repos/sample_app'

count = content.count(old_path)
print('Found ' + str(count) + ' occurrences of wrong path')
